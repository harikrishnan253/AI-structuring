...
- **AI-Powered Analysis** - Leverages Google Gemini 2.5 Flash for intelligent content classification
...
The system tracks token usage and calculates costs based on Gemini 2.5 Flash pricing:
...
Average cost per document: ~$0.03
